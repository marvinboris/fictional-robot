  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = exams.map(function (exam) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.updateObject)(exam, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.getExams(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.deleteExams(id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.resetExams());
    }
  };
};
