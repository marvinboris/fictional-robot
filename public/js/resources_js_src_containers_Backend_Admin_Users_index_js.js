  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = users.map(function (user) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.updateObject)(user, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.convertDate)(user.created_at),
          photo: user.photo && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)("div", {
            className: "d-flex",
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.getUsers(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.deleteUsers(id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.resetUsers());
    }
  };
};
