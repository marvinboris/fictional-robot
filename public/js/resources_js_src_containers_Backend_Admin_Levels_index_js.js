  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = levels.map(function (level) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.updateObject)(level, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.convertDate)(level.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.getLevels(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.deleteLevels(id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.resetLevels());
    }
  };
};
