  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = sessions.map(function (session) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.updateObject)(session, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.getSessions(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.deleteSessions(id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.resetSessions());
    }
  };
};
