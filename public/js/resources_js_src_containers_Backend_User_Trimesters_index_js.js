  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = trimesters.map(function (trimester) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.updateObject)(trimester, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.convertDate)(trimester.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.getTrimesters(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.deleteTrimesters(id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.resetTrimesters());
    }
  };
};
