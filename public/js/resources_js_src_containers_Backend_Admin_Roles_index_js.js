  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = roles.map(function (role) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_11__.updateObject)(role, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_11__.convertDate)(role.created_at),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_10__.getRoles(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_10__.deleteRoles(id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_10__.resetRoles());
    }
  };
};
