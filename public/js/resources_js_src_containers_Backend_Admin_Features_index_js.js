...
var Index = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var feedback = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_Feedback_Feedback__WEBPACK_IMPORTED_MODULE_8__.default, {
        message: message
      });

      if (!features) features = [];
      var data = features.map(function (feature) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_11__.updateObject)(feature, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_11__.convertDate)(feature.created_at),
      ...
      var content = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Fragment, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_10__.getFeatures(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_10__.deleteFeatures(id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_10__.resetFeatures());
    }
  };
};
