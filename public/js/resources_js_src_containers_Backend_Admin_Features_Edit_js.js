  ...
  _createClass(Edit, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.features.feature && prevState.name === '') {
        ...
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_13__.updateObject)(prevState, _objectSpread({}, feature));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_12__.getFeature(id));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_12__.patchFeatures(id, data));
    },
