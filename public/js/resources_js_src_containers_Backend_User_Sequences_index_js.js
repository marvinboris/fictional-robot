  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = sequences.map(function (sequence) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.updateObject)(sequence, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.getSequences(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.deleteSequences(id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.resetSequences());
    }
  };
};
