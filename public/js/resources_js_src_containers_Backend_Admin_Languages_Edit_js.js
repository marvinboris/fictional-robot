  ...
  _createClass(Edit, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.languages.language && prevState.name === '') {
        ...
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_13__.updateObject)(prevState, _objectSpread({}, language));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_12__.getLanguage(id));
    },
    patch: function patch(data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_12__.patchLanguages(data));
    },
