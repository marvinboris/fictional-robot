  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = exam_types.map(function (exam_type) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_12__.updateObject)(exam_type, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.getExamTypes(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.deleteExamTypes(id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_11__.resetExamTypes());
    }
  };
};
